  ...
  return (
    <main>
      ...
      {movieList.map((filme, key)=>(
        <BannerScreen key={key} filme = {filme.items.filmes[55]} />
      ))}
      {movieList.map((filme, key)=>(
        <BtnsActions key={key} filme = {filme.items.filmes[55]} />
      ))}
      <br />
      <br />
      <CardsFilmes/>
...
export default VelozeseFuriosos9