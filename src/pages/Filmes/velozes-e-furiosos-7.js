  ...
  return (
    <main>
      ...
      {movieList.map((filme, key)=>(
        <BannerScreen key={key} filme = {filme.items.filmes[53]} />
      ))}
      {movieList.map((filme, key)=>(
        <BtnsActions key={key} filme = {filme.items.filmes[53]} />
      ))}
      <br />
      <br />
      <CardsFilmes/>
...
export default VelozeseFuriosos7