  ...
  return (
    <main>
      ...
      {movieList.map((filme, key)=>(
        <BannerScreen key={key} filme = {filme.items.filmes[54]} />
      ))}
      {movieList.map((filme, key)=>(
        <BtnsActions key={key} filme = {filme.items.filmes[54]} />
      ))}
      <br />
      <br />
      <CardsFilmes/>
...
export default VelozeseFuriosos8